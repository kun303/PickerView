...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            if (mPickerOptions.onConformClickListener!=null){
                btnSubmit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        returnData();
                        mPickerOptions.onConformClickListener.onClick(OptionsPickerView.this);
                    }
                });
            }else{
            ...
            if (mPickerOptions.onCancelClickListener!=null){
                btnCancel.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        returnData();
                        mPickerOptions.onCancelClickListener.onClick(OptionsPickerView.this);
                    }
                });
            }else{
            ...
            if (mPickerOptions.visibleCount!=0) {
                WheelView.itemsVisible = mPickerOptions.visibleCount+2;
            }
        ...
        if (mPickerOptions.visibleCount!=0){
            wheelOptions.setVisibleCount(mPickerOptions.visibleCount);
        }
