...
import com.newolf.pickerview.listener.OnConformClickListener;
...
public class OptionsPickerBuilder {
    ...
    public OptionsPickerBuilder setVisibleItemCount(int count) {
        ...
        if (count % 2 == 0) {
            throw new IllegalArgumentException("count must be %2 != 0 ");
        }

        mPickerOptions.visibleCount = count+2;
        return this;
    }

    public OptionsPickerBuilder setCancelOnClickListener(OnCancelClickListener onCancelClickListener) {
        mPickerOptions.onCancelClickListener = onCancelClickListener;
        return this;
    }

    public OptionsPickerBuilder setConformOnClickListener(OnConformClickListener onConformClickListener) {
        mPickerOptions.onConformClickListener = onConformClickListener;
        return this;
    }
}
